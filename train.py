...
def main():
    ...
    opt.data = work_path + 'data/data_processed.pth'
    opt.save_model =  work_path + 'save_model/model.chkpt'
    opt.no_cuda = True
    ...
    opt.max_token_seq_len = data['setting'].max_seq_len
